...
def n2c(sen, twoalt=True):
    r = ''

    lst = re.split(r'([\d\.\-]+)', sen)
    # print('lst:', lst)

    for j in lst:
        try:
            j1 = num2chinese(j, twoalt=twoalt)
            r += j1
        except Exception:
            r += j
    return r
...
if __name__ == "__main__":
    ...
    # print(num2chinese("25-11"))
    print(num2chinese("-11"))
    # print(num2chinese("2418.91", twoalt=True))

    s = "你欠我3418.91元，我欠他2234.38元"
    s = "哦，八千里是我们活动，在九月25-11月二十五岁的时间，就可以打电话预约拍照，也可以在网上下单。"
    # print(n2c(s, twoalt=False))
